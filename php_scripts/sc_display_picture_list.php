...
/*   Updated: 2016/09/26 12:45:36 by tbouder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			echo "<div class='picture_list_content_2'>";
				...
				if ($_SESSION["user_activ"] != 0)
				{
					echo "<span class='picture_list_text_content'>";
						...
						echo "<span class='like' onclick='ft_dislike(\"".$name."\", \"".$current_page."\")'>";
						...
						echo "<span class='dislike' onclick='ft_like(\"".$name."\", \"".$current_page."\")'>";
