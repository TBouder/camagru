...
/*   Updated: 2016/09/27 23:58:27 by tbouder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	if ($_GET['name'])
	{
		...
		$picture = ft_exec_sql("fetchAll", $sql)[0];
		...
		echo "<div class='picture_details_container'>";
			...
			if ($picture['owner'] == $_SESSION['loggued_on_user'])
				...
				echo "<form method='POST' action='".PROJECT_SCRIPTS."sc_add_comment.php'>";
					...
					echo "<textarea rows='4' cols='40' maxlength='130' wrap='hard' name='comment' class='comment_area'></textarea></br>";
					echo "<input type='submit' name='submit' value='Submit' class='comment_submit' />";
				echo "</form>";
		echo "</div>";
	}
?>
